  ...
  return (
    <footer className="relative overflow-hidden pb-16 lg:pb-0">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[hsl(150_25%_8%/0.75)]" />
      </div>

      {/* Animated clouds */}
      <CloudSVG className="absolute top-6 text-white/10 w-32 h-12 animate-[float-cloud_30s_linear_infinite]" />
      <CloudSVG className="absolute top-16 text-white/15 w-24 h-10 animate-[float-cloud_40s_linear_8s_infinite]" />
      <CloudSVG className="absolute top-3 text-white/[0.07] w-40 h-14 animate-[float-cloud_25s_linear_15s_infinite]" />
