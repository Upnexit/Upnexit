  ...
  'mehedi-hasan': {
    ...
    education: [
      ...
      },
      {
        ...
        place: 'Al Helal Islami Academy & College, Sapahar, Naogaon',
        placeBn: 'আল হেলাল ইসলামি একাডেমি অ্যান্ড কলেজ, সাপাহার, নওগাঁ',
      },
      {
        year: 'Primary',
