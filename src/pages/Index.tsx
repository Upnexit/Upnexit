...
const Index = () => {
  return (
    <div className="min-h-screen pb-0 overflow-x-hidden">
      <SEOHead
        title="Upnex It — Software & IT Company in Naogaon, Bangladesh"
        description="Upnex It (Upnexit) — software & IT company in Naogaon, Bangladesh. Custom software, school & hospital management, ERP, web and mobile apps."
