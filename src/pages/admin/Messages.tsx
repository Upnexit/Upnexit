    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { label: 'মোট মেসেজ', value: messages.length, icon: MessageSquare, gradient: 'linear-gradient(135deg, #3b82f6 0%, #06b6d4 100%)', glow: '#3b82f655' },
            { label: 'অপঠিত', value: unreadCount, icon: Clock, gradient: 'linear-gradient(135deg, #ec4899 0%, #f43f5e 100%)', glow: '#ec489955' },
